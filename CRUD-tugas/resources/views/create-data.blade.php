            ...
            <div class="row page-bg">
                <div class="p-4 col-md-12">
                    <div class="text-center top-icon">
                        ...
                        <form id="form-login" action="{{ route('announces.buat-data') }}" method="post">
                            @csrf
                            <div>
                            ...
                            <div>
                                <input class="mt-3 form-control form-control-lg" name="tahunmasuk" type="text"
                                       placeholder="tahunmasuk" autofocus required>
                            </div>
                            ...
                            <div>
                                <input class="mt-3 form-control form-control-lg" name="ips" type="text"
                                       placeholder="ips" autofocus required>
                            </div>
